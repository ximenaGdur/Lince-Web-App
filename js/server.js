...
class Server {
  ...
  constructor() {
    ...
    this.cardRoutes = [
      ...
      { description: 'Estrella de mar', route: 'starfish.png' },
      ...
      { description: 'Portatil', route: 'laptop.png' },
      { description: 'Policia', route: 'police.png' },
      { description: 'Bombero', route: 'firefighter.png' },
      { description: 'Químico', route: 'chemist.png' },
      { description: 'Arquitecto', route: 'architect.png' },
      { description: 'Pintor', route: 'painter.png' },
      { description: 'Mecánico', route: 'mechanic.png' },
      { description: 'Profesor', route: 'teacher.png' },
      { description: 'Cantante', route: 'singer.png' },
      { description: 'Atleta', route: 'athlete.png' },
      { description: 'Capitán', route: 'captain.png' },
      { description: 'Programador', route: 'programmer.png' },
      { description: 'Chef', route: 'chef.png' },
      { description: 'Abogado', route: 'lawyer.png' },
      { description: 'Trabajador', route: 'worker.png' },
      { description: 'Doctor', route: 'doctor.png' },
      { description: 'Balanza', route: 'scale.png' },
      { description: 'Exprimidor', route: 'juicer.png' },
      { description: 'Tostadora', route: 'toaster.png' },
      { description: 'Embudo', route: 'funnel.png' },
      { description: 'Tetera', route: 'kettle.png' },
      { description: 'Temporizador', route: 'timer.png' },
      { description: 'Sarten', route: 'pan.png' },
      { description: 'Microondas', route: 'microwave.png' },
      { description: 'Refrigeradora', route: 'fridge.png' },
      { description: 'Plato', route: 'dish.png' },
      { description: 'Tazón', route: 'bowl.png' },
      { description: 'Vaso', route: 'glass.png' },
      { description: 'Taza', route: 'cup.png' },
      { description: 'Rayador', route: 'grater.png' },
      { description: 'Cuchara', route: 'spoon.png' },
      { description: 'Tenedor', route: 'fork.png' },
      { description: 'Rodillo', route: 'roller.png' },
      { description: 'Espátula', route: 'spatula.png' },
      { description: 'Olla', route: 'pot.png' },
      { description: 'Horno', route: 'oven.png' },
      { description: 'Batidor de mano', route: 'whisk.png' },
      { description: 'Licuadora', route: 'blender.png' },
      { description: 'Servilleta', route: 'napkin.png' },
      { description: 'Cuchillo', route: 'knife.png' },
      { description: 'Batidora', route: 'beater.png' },
      { description: 'Hilo', route: 'floss.png' },
      { description: 'Pasta', route: 'toothpaste.png' },
      ...
      { description: 'Aplicadores', route: 'qtips.png' },
      { description: 'Espejo', route: 'mirror.png' },
      { description: 'Alisador', route: 'straightener.png' },
      ...
      { description: 'Crema', route: 'cream.png' },
      { description: 'Pincel', route: 'brush.png' },
      { description: 'Secadora', route: 'hairdryer.png' },
      { description: 'Pintalabios', route: 'lipstick.png' },
      { description: 'Perfume', route: 'perfume.png' },
      { description: 'Radio', route: 'radio.png' },
      { description: 'Disco', route: 'disc.png' },
      { description: 'Proyector', route: 'projector.png' },
      { description: 'USB', route: 'usb.png' },
      { description: 'Calculadora', route: 'calculator.png' },
      { description: 'Tableta', route: 'tablet.png' },
      { description: 'Micrófono', route: 'microphone.png' },
      { description: 'Impresora', route: 'printer.png' },
      { description: 'Batería', route: 'battery.png' },
      { description: 'Televisión', route: 'tv.png' },
      { description: 'Cable', route: 'cable.png' },
      { description: 'Parlante', route: 'speaker.png' },
      { description: 'Satélite', route: 'satellite.png' },
      { description: 'Robot', route: 'robot.png' },
      { description: 'Dron', route: 'drone.png' },
      { description: 'Cámara', route: 'camera.png' },
      { description: 'Control', route: 'controller.png' },
      { description: 'Consola', route: 'console.png' },
      { description: 'Computadora', route: 'computer.png' },
      { description: 'Audífonos', route: 'headphones.png' },
      { description: 'Teclado', route: 'keyboard.png' },
